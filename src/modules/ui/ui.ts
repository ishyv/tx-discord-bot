/**
 * Motivación: ofrecer primitivas de interfaz (ui) para manejar el registro y ejecución de componentes interactivos.
 *
...
export type BuildMessageFn<T extends Record<string, unknown>> = (
  ...
  update: () => Promise<void>,
) => InteractionCreateBodyRequest & { modal?: Modal };

export type SenderFn = (
  msg: InteractionCreateBodyRequest & { modal?: Modal },
) => Promise<void | WebhookMessage>;
...
export async function open_modal(
  ctx: CommandContext,
