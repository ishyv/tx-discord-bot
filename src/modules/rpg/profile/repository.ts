...
function toDomain(userId: string, data: RpgProfileData): RpgProfile {
  return {
    ...
    starterKitType: data.starterKitType,
    starterKitClaimedAt: data.starterKitClaimedAt,
...
function toData(profile: RpgProfile): RpgProfileData {
  return {
    ...
    starterKitType: profile.starterKitType,
    starterKitClaimedAt: profile.starterKitClaimedAt,
