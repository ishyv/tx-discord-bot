...
import { itemEngine, type ItemTransaction, type ItemTransactionResult } from "./engine";
...
export async function itemTransaction(
    ...
    return runUserTransition(userID, {
        ...
        commit: (id, expected, next) => UserStore.replaceIfMatch(id, { inventory: expected } as any, { inventory: next } as any),
