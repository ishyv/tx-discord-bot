/**
 * Balance Subcommand (Part of /wallet).
 *
 * Purpose: Display user balance with improved UX.
 * Context: Shows coins, reputation, and handles account states.
 */
...
@HelpDoc({
    ...
    description: "Shows your current coin balance and reputation",
...
export default class WalletBalanceSubcommand extends SubCommand {
