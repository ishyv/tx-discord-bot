/**
 * Motivación: registrar el comando "moderation / autorole / preset" dentro de la categoría moderation para ofrecer la acción de forma consistente y reutilizable.
 *
