/**
 * Craft Subcommand (Part of /rpg).
 *
 * Purpose: List available recipes and craft items.
 * Context: RPG crafting system with recipe requirements.
 * Note: This replaces the standalone /craft command.
 */
import {
    Declare,
    SubCommand,
...
export default class RpgCraftSubcommand extends SubCommand {
    ...
    private async showRecipeList(
        ...
        const embed = new Embed()
            ...
            .setDescription("Use `/rpg craft recipe:<id>` to craft an item.");
